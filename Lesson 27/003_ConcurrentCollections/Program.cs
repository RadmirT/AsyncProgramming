...
movieRating.TryAdd("Бойцовский клуб", 8.8);
...
Console.WriteLine($"У фильма Тёмный рыцарь - {movieRating.GetOrAdd("Тёмный рыцарь", 9.0)} \n");

var isSuccess = movieRating.TryRemove("Santa Barbara", out double _);
